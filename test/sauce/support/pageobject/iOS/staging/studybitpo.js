  ...
  reopenKeyTermStudyBit: function (browser, done, keytermSBId) {
    ...
    createKeyTermStudyBit: function (browser, done, keytermSBId, definition, comprehension, publishertag, notes, usertag, windowScrollY) {
        return browser
            ...
            .then(function (keytermSBLocation) {
              return browser.getLocationInView(keytermSBLocation)
                .execute("window.scrollBy(0,-140)")
                .sleep(1000)
                .waitForElementByCss("#" + keytermSBId +"", asserters.isDisplayed, 90000)
                .click()
    ...
    navigateToStudyBoard: function (browser, done) {
        browser
            ...
            .click()
            .sleep(4000)
            .waitForElementByXPath("//div[@class='icon-studyboard-blue']//parent::a", asserters.isDisplayed, 120000)
            .click()
            ...
            .waitForElementByCss("#" + studybitId, asserters.isDisplayed, 30000).then(function(studybitText){
                return browser
                  ...
                  .click().then(function () {
                          return  browser
                          .waitForElementByXPath("//div[contains(@class,'studybit-menu text unassigned editing')]//div[@class='actions']/button[contains(@class,'save')]", asserters.isDisplayed, 60000)
                          // .waitForElementByXPath("//div[contains(@class,'menu studybit-details ng-scope')]//div[@class='actions']/button[contains(@class,'save')]").text()
                          // .then(function (studyBitSaveButton) {
                          //  if(studyBitSaveButton.indexOf("SAVE")>-1){
                          //    console.log("contains save button");
                          //    return browser
                          //     .waitForElementByXPath("//div[contains(@class,'studybit-icon text saved fair')]", asserters.isDisplayed, 60000)
                          //     .nodeify(done);
                          //     }
                          //     else{
                          //       report.stepStatusWithData(" Studybit popup does not contains 'Save button'") +
                          //       report.reportFooter();
                          //     }
                          //   })
    ...
    clickOnInlineLink : function(browser, id, text){
      return browser
      .waitForElementByXPath("//p[@id='" + id + "']//a[contains(.,'" + text + "')]", asserters.isDisplayed, 60000)
      .click();
    },
   ...
   editStudybitWithTag: function(browser, usertag){
         return browser
             .waitForElementByXPath("(//li[contains(@class,'tile')]//div[contains(@class,'studybit text')])", asserters.isDisplayed, 30000).then(function(textStudybit){
               return browser
                .getLocationInView(textStudybit)
                .waitForElementByXPath("(//li[contains(@class,'tile')]//div[contains(@class,'studybit text')])", asserters.isDisplayed, 30000)
                .click()
                .sleep(2000)
                .waitForElementByXPath("//section[@class='studybit-details']//ul//li//a[contains(text(),'TAGS')]", asserters.isDisplayed, 30000)
                .click()
