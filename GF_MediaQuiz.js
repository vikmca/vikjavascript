    ...
    simplemocha: {
        ltr: {
            ...
            reporter: 'mochawesome',
                  reporterOptions: {
                     reportName: 'GF_MediaQuiz_result'
                   },
            timeout: 120000,
            colors: true,
            summery: true,
            captureFile: 'GF_MediaQuiz_result.html', // Optionally capture the reporter output to a file
...
//currently implimeted features(different scores strategy for media quiz) are not working
                   'test/sauce/sanity/assignment/mediaQuiz/validateAverageScoreMediaQuiz.js',
                   'test/sauce/sanity/assignment/mediaQuiz/validateHighScoreMediaQuiz.js',
                   'test/sauce/sanity/assignment/mediaQuiz/validateDropLowestAverageScoreMediaQuiz.js',
            ]
