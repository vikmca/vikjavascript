...
describe(scriptName + 'VALIDATE USER IS NOT ABLE TO ATTEMPT STUDYBIT PRACTICE QUIZ POST DELETING ALL STUDYBITS', function() {
	var browser;
	var allPassed = true;
	var userType;
	var courseName;
	...
	before(function(done) {
		...
		totalTime = 0;
		//Reports
		console.log(report.formatTestName("INSTRUCTOR :: 4LTR FEATURES :: USER IS NOT ABLE TO ATTEMPT STUDYBIT PRACTICE QUIZ POST DELETING ALL STUDYBITS"));
		console.log("======================================");
