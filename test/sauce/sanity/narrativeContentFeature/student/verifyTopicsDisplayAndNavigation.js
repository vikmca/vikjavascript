...
describe(scriptName + 'CHAPTER LIST VIEW VALIDATION', function() {
	...
	it(". Validate the chapter title and chapter number changed on expanding another chapter", function(done) {
	...
	it(". Verify Chapter Introduction and Navigate to Chapter Review By next Button", function(done) {
		this.timeout(courseHelper.getElevatedTimeout("quiz"));
		recursiveFnPage.verifyChapterIntroductionAndClickNext(browser, done);
	});

	it(". Verify Key Term and Games on Chapter Review", function(done) {
	...
	it(". Validate previous arrow button is hide under 1st topic", function(done) {
	...
	it(". Validate previous button is hide under 1st topic", function(done) {
