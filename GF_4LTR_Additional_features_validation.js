	...
	simplemocha: {
		ltr: {
			options: {
				...
				reporterOptions: {
					reportName: 'GF_4LTR_Additional_features_validation'
				},
				timeout: 90000,
				colors: true,
				summery: true,
				captureFile: 'GF_4LTR_Additional_features_validation.html', // Optionally capture the reporter output to a file
			...
			src: [
				...
				'test/sauce/sanity/courseCreation/validateProductSpecificCourse.js', //fail on IE // flashcard pass on safari except delete course
				'test/sauce/sanity/courseCreation/validateDropCourseFromStudent.js', //pass on safari except delete course pass on mobile
				'test/sauce/sanity/courseCreation/validateDropStudentFromCourse.js', //pass on safari except delete course pass on mobile
				'test/sauce/sanity/TA/validateSwitchCourseFeatureForTA.js', //pass on safari today
				'test/sauce/sanity/TA/validateTAStudentHasInstructorPrivileges.js', //pass on safari except delete course
				'test/sauce/sanity/courseCreation/validateClassAverageScoreForMultipleStudent.js', //step 88 fail on INT //pass on safari except delete course
				'test/sauce/sanity/courseCreation/validateOverriddenAttemptAndDueDateForSpecificStudentNotReflectForOtherStudent.js', //pass on safari except delete course
				'test/sauce/sanity/TA/validateTaAdditionalInstructorFeature.js', //pass on safari today
				'test/sauce/sanity/studentCreationAndFeature/studentFeatureAccessControl.js',
				'test/sauce/sanity/courseCreation/courseCreationAndEulaAndVisitedChapterValidation.js',
			]
		}
	},
	jshint: {
