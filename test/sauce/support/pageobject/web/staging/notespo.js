...
module.exports = {
    ...
    change2ndNotesComprehension: function (browser, done) {
     browser
      .sleep(1000)
      .waitForElementByXPath("(//div[contains(@class,'studybit note')])[2]", asserters.isDisplayed, 90000)
      .click()
      .sleep(1000)
      .waitForElementByXPath("//div[contains(@class,'button-group')]/button[contains(text(),'FAIR')]", asserters.isDisplayed, 90000)
      .click()
      .sleep(2000)
      .waitForElementByCss(".save.ng-binding", asserters.isDisplayed, 90000)
      .click()
