...
describe(scriptName + 'INSTRUCTOR :: CHAPTER LIST VIEW VALIDATION', function() {
	var browser;
	var allPassed = true;
	var userType;
	var courseName;
	...
	before(function(done) {
		...
		totalTime = 0;
		//Reports
		console.log(report.formatTestName("4LTR FEATURES :: vALIDATE TRANSCRIPT AND DOWNLOAD TRANSCRIPT BUTTON SHOULD PRESENT FOR EACH VIDEOS"));
