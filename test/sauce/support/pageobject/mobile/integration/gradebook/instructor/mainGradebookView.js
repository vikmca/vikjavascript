...
module.exports = {
    ...
    overrideTheScore: function (browser) {
      ...
      pointGainedByStudent: function (browser, userName) {
        return browser
            .waitForElementByXPath("//div[@class='student-name']/a[contains(text(),'"+userName+"')]/parent::div/parent::td/following-sibling::td/div[@class='total-points ng-binding']", asserters.isDisplayed, 60000);
