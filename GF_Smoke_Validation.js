...
var gruntConfig = {
    ...
    simplemocha: {
        ltr: {
            ...
            reporter: 'mochawesome',
                  reporterOptions: {
                     reportName: 'GF_Smoke_Validation'
                   },
            timeout: 120000,
            colors: true,
            summery: true,
            captureFile: 'GF_Smoke_Validation.html', // Optionally capture the reporter output to a file
            ...
            src: [
                   ...
                   'test/sauce/sanity/concepttracker/student/conceptTracker.js', //pass on safari
                   'test/sauce/sanity/studyBoard/student/smokeFeatures.js',
                   'test/sauce/sanity/assignment/assessment/studentAssignmentSubmission.js',
                   'test/sauce/sanity/assignment/docsAndLinks/searchServiceForTextAndDocValidation.js',
                   'test/sauce/sanity/narrativeContentFeature/student/CASExpositionAssignments.js', //fixed pass for both FF and IE on MKTG9 issue on PSYCH4 assessment rendering time pass on safari pass on mobile
                   'test/sauce/sanity/practiceQuiz/student/takeAPracticeQuizAsStudent.js',
                   'test/sauce/sanity/practiceQuiz/student/retakePracticeQuizAsStudent.js',
                   'test/sauce/sanity/assignment/chapterContent/chapterReadingCompleteValidation.js', //Pass on IE and FF both and Safari pass on mobile
                   'test/sauce/sanity/concepttracker/student/validateVideoCountOnConceptTracker.js', //Pass on both FF and IE pass on safari pass on mobile
                   'test/sauce/sanity/assignment/mediaQuiz/validateMediaQuiz.js'
            ]
    ...
    zip: {
        ...
        'location/to/zip/files.zip': ['mochawesome-reports/to/zip.html', 'another/file.json']
    }
