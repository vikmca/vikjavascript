...
describe(scriptName + ' STUDENT ::  STUDYBIT CREATION AND STUDYBOARD VALIDATION', function() {
	var browser;
	var allPassed = true;
	var userType;
	var courseName;
	...
	before(function(done) {
		...
		totalTime = 0;
		//Reports
		console.log(report.formatTestName("STUDENT :: 4LTR FEATURES :: STUDYBIT CREATION AND VALIDATION"));
		console.log("======================================");
	...
	it(". Validate on clicking 'Clear all' button then all chapters will be unchecked", function(done) {
		browser
