        ...
        ltr: {
            options: {
                reporter: 'mochawesome',
                  reporterOptions: {
                     reportName: 'Gruntfile_sanity_cengage_course_service'
                   },
                  timeout: 60000,
                  colors: true,
                  summery: true,
                  captureFile: 'Gruntfile_sanity_cengage_course_service.html', // Optionally capture the reporter output to a file
            ...
            src: [
                ...
                'test/sauce/sanity/courseCreation/courseCreationAndAssignmentCreationVerification.js',
                'test/sauce/sanity/courseCreation/validateCopyCourseFromSameAndDifferentInsrtructor.js'
            ]
