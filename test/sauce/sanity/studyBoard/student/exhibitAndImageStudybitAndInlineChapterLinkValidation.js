...
describe(scriptName + ' STUDENT :: TABLE/IMAGE STUDYBIT, INTERNAL EXHIBIT LINKS, CHAPTER LINKS VALIDATION', function() {
	var browser;
	var allPassed = true;
	var userType;
	var courseName;
	...
	before(function(done) {
		...
		console.log(report.formatTestName("STUDENT :: TABLE/IMAGE STUDYBIT, INTERNAL EXHIBIT LINKS, CHAPTER LINKS VALIDATION"));
