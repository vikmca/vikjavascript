...
module.exports = {
    ...
    clickOnMenu: function(browser){
      return browser
      .sleep(4000)
    //   .execute("return document.getElementsByClassName('navigation-menu-button')[0].click()")
      // .sleep(3000);
      .waitForElementByXPath("//div[contains(@class,'navigation-menu-button')]", asserters.isDisplayed, 120000)
      .click()
      .sleep(3000);
    ...
    clickOnStudybit: function(browser, done){
        return browser.waitForElementByXPath("//a[contains(text(),'StudyBits')]", asserters.isDisplayed, 30000)
        .click()
        .sleep(4000)
        .nodeify(done);
    }
