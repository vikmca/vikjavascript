...
module.exports = {
    ...
    getTextOfSelectedActivity : function(browser, activityListPosition) {
     ...
     validateIfPreviewVideoIsPresent : function(browser) {
       return browser
       .sleep(3000)
       .hasElementByCss(".cas-mediaquiz>video");
     },

     clickOnQuestionMark : function(browser,countOfQuestionMark) {
    //    return browser
    //    .waitForElementByXPath("//div[contains(@class,'cas-mediaquiz-progressbar-section')][" + countOfQuestionMark + "]//span",asserters.isDisplayed, 60000)
    ...
    //    });
     ...
     getMaxPointsFromListView: function(browser){
       return browser
         .waitForElementByXPath("//div[contains(@class,'assignment-list-container')]//td[contains(@data-heading,'Max Points')]",asserters.isDisplayed, 15000);
     },

     getAttemptsFromListView: function(browser){
       return browser
         .waitForElementByXPath("//div[contains(@class,'assignment-list-container')]//td[contains(@data-heading,'Attempts')]",asserters.isDisplayed, 15000);
     },
     ...
     showTranscriptButton: function (browser) {
      ...
      getActivity : function(browser){
        return browser
            .sleep(1000)
			.waitForElementsByCss(".media-quiz-selection li h3", asserters.isDisplayed, 60000);
      },

      getActivityText : function(browser, activityListCount){
         return browser
              .sleep('1000')
              .waitForElementByXPath("//ul[@class='media-quiz-selection']//li[" + activityListCount + "]//h3[@class='ng-scope ng-binding']", asserters.isDisplayed, 60000)
              .text();
      }
  };
