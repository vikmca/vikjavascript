...
var gruntConfig = {
    ...
    simplemocha: {
        ltr: {
          ...
          reporterOptions: {
             reportName: 'GF_StudyBoardFeature_result'
           },
          timeout: 60000,
          colors: true,
          summery: true,
          captureFile: 'GF_StudyBoardFeature_result.html', // Optionally capture the reporter output to a file
          ...
          clearRequireCache: true
            ...
            src: [
              ...
              'test/sauce/sanity/narrativeContentFeature/student/validateReadsSpeaker.js',
              'test/sauce/sanity/studyBoard/student/exhibitAndImageStudybitAndInlineChapterLinkValidation.js', //Pass on IE and have to check on FF pass on safari pass on mobile
              'test/sauce/sanity/studyBoard/student/flashcardAccessOnTocForEachChapter.js', //pass on IE problem with FF on carousel pass on safari
              'test/sauce/sanity/practiceQuiz/student/validatePracticeQuizResultPage.js',//Pass on both IE and FF pass on safari
              'test/sauce/sanity/narrativeContentFeature/student/validateAHeadBHeadCHeadTagsWhileCreatingContiguousStudyBit.js',//Pass on IE and fail on FF after topic navigation pass on safari
              'test/sauce/sanity/narrativeContentFeature/student/validateFooterCopyrightLabels.js',//Pass on both IE and FF pass on safari and mobile iOS
              'test/sauce/sanity/studyBoard/student/validateNotes.js', // pass for both IE and FF pass on safari
              'test/sauce/sanity/narrativeContentFeature/student/verifyTopicsDisplayAndNavigation.js',//pass for both IE and FF pass on safari
              'test/sauce/sanity/studyBoard/student/validatingAndReviewingPublisherFlashcards.js',
              'test/sauce/sanity/practiceQuiz/student/takeAPracticeQuizForStudyBitsAsStudent.js',//pass on safari
              'test/sauce/sanity/practiceQuiz/instructor/takeAPracticeQuizAsInstructor.js',//pas on safari
              'test/sauce/sanity/practiceQuiz/instructor/retakePracticeQuizAsInstructor.js',//pas on safari
              'test/sauce/sanity/concepttracker/student/validateTakeRetakePracticeQuiz.js',
              'test/sauce/sanity/studyBoard/student/flashcardReviewDeckValidation.js',
              'test/sauce/sanity/studyBoard/student/validateStudybitPracticeQuizPostdeletingAllStudybit.js',//fail on IE //pass on safari
              'test/sauce/sanity/studyBoard/student/validateAndReviewUserFlashCard.js',//pass on safari
              'test/sauce/sanity/studyBoard/student/validateStudybitonChapterReview.js',//pass on safari
              'test/sauce/sanity/studyBoard/student/validateMathEquationStudybit.js', // pass on IE and fail on FF after topic navigation pass on safari and android and iphone
              'test/sauce/sanity/studyBoard/student/validateStudybit.js',//pass FF and IE pass on safari fail on FF (Verify the presence of text StudyBit on StudyBoard)
              'test/sauce/sanity/concepttracker/student/takeNewAndPastPracticeQuizAndAnalyticsValidation.js',
            ]
        }
    },
    jshint: {
        ...
        test: {
          ...
          //src: ['test/sauce/sanity/validateGradesOnFutureDateAssignments.js']
        }
    },
    concurrent: {
