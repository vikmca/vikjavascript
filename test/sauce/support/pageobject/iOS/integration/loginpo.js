 ...
 loginToApplication: function (browser, userType, done) {
    ...
    launchACourse: function (userType, courseName, browser, done) {
        if (userType === "instructor") {
            ...
            browser
                ...
                .click()
                .waitForElementByXPath("//div[contains(@class,'navigation-menu-button')]", asserters.isDisplayed, 90000)
                .nodeify(done);
            // browser
            //     .waitForElementByXPath("//a[contains(@data-track-ext,'" + courseName + "')]", asserters.isDisplayed, 20000)
            //     .execute("return document.evaluate(\"//a[contains(@data-track-ext,'"+courseName+"')]\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click()")
            //     .sleep(1000)
    ...
    launchCourseOnManageCourse: function(browser, courseName, done){
     browser
         ...
         .execute("return document.evaluate(\"//td[contains(.,'"+courseName+"')]//a\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click()")
         .sleep(1000)
         .windowHandles().then(function (handles) {
           var cengageBrain = handles[1];
             return  browser
