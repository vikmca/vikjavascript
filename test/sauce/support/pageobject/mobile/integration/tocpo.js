       ...
       topicid = topic + topicno;
        return browser
            .waitForElementByCss(".chapter.ng-scope.selected ul[class='topics-list'] li:nth-child(" + topicid + ") a", asserters.isDisplayed, 90000).then(function(topic){
              ...
              .sleep(3000)
              .execute("return (document.evaluate(\"//div[@selected-chapter='selectedChapter']\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue).scrollIntoView()")
              .sleep(2000)
              // .execute("window.scrollBy(0,-140)")
              // .sleep(1000)
              .then(function(){
                return browser
                    .waitForElementByCss(".chapter.ng-scope.selected ul[class='topics-list'] li:nth-child(" + topicid + ") a", asserters.isDisplayed, 90000).click().then(function(){
                    done();
                });
              });
            });
