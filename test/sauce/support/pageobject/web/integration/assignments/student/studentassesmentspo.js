...
var assignmentpage = require("../../../../../pagefactory/studentAssignment.json");
...
module.exports = {
    ...
    launchAssignment: function (browser, assignmentName) {
          ...
          .waitForElementByXPath("//span[contains(@class,'assessment-title') and contains(text(),'"+assignmentName+"')]", asserters.isDisplayed, 30000)
          .sleep(1000)
          .click()
    ...
    getAssignmentAttemptCount: function(browser , assignmentName){
      return browser
             .waitForElementByXPath("//span[@class='ng-binding assessment-title-link'][text()='"+assignmentName+"']/parent::div/parent::div/div[@class='attempts ng-binding']/span").text();
    },
    ...
    getAttemptTextOfAssessment: function (browser, assignmentName) {
        return browser
            .waitForElementByXPath("//span[contains(@class,'assessment-title') and contains(text(),'"+assignmentName+"')]/parent::div//parent::div//following-sibling::div[@class='attempts ng-binding']//span", asserters.isDisplayed, 60000)
    ...
    getTextOfAssignmentChapter: function(browser, assessmentname){
      return browser
          // .waitForElementByXPath("//span[contains(@class,'assessment-title')]/div[contains(text(),'"+assessmentname+"')]/parent::span//following-sibling::div[@class='topic']//span", asserters.isDisplayed, 60000)
            .waitForElementByXPath("//span[contains(@class,'assessment-title-link') and contains(text(),'"+assessmentname+"')]/parent::div//following-sibling::div[@class='topic']//span", asserters.isDisplayed, 60000)
            .text();
    },
    ...
    getAttemptTextOfAssessmentNameOnToday : function(browser){
      return browser
      .sleep(2000)
      .waitForElementByCss(".assessment-title .assessment-attempt-in-progress", asserters.isDisplayed, 30000);
    ...
    verifyAssignmentNameDisabled : function(browser, astname){
      return browser
        .waitForElementByXPath("//span[@class='ng-binding disabled-assessment'][contains(text(),'" + astname + "')]", asserters.isDisplayed, 60000);
    },

    clickOnAssignment : function(browser, astname){
      return browser
          .sleep(1000)
          .waitForElementByXPath("//div[contains(@class,'assessment-title')]//span[contains(@class,'assessment-title-link') and contains(text(),'"+astname+"')]", asserters.isDisplayed, 60000)
          .click();
    },
    ...
    validateAssignmentIsPresentOnStudentCalendar: function(browser, assignmentName) {
      return browser
        .waitForElementByXPath("//div[contains(@class,'assessment-title')]/span[contains(text(),'"+assignmentName+"')][1]", asserters.isDisplayed, 30000);
    ...
    assignmentVisibilityStatusOnFutureDate: function(browser) {
      return browser
        .sleep(1000)
        .waitForElementByXPath("//div[@class='day ng-scope']//span[@class='number ng-binding' and text()='1']/parent::span/following-sibling::a[@class='assignment-due']/parent::div", asserters.isDisplayed, 10000)
        .isDisplayed()
        .should.become(true);
    },
    ...
    assignmentVisibilityTrueStatusOnFutureDate: function(browser) {
      return browser
        .sleep(1000)
        .hasElementByXPath("//div[@class='day ng-scope']//span[@class='number ng-binding' and text()='1']/parent::span/following-sibling::a[@class='assignment-due ng-hide']/parent::div");
    },
