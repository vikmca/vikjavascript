        ...
        if(stringutil.removeBoundaryQuotes(process.env.RUN_IN_BROWSER.toString())==="safari"){
          browser
              ...
              browser
                  ...
                  // .execute("document.getElementsByClassName('csmSectionProductLink')[0].scrollIntoView(true)")
             ...
             return browser
                 ...
                 return browser
                   ...
                   //   .maximize()
                     ...
                     .type(data.password)
                     .sleep(3000)
                     .execute("return window.scrollBy(0,2000)")
                     .waitForElementByCss("button[value='Sign In']", asserters.isDisplayed, 60000)
                     // .waitForElementByXPath("//input[contains(@value,'Sign In')]", asserters.isDisplayed, 60000)
                     .click()
                     .sleep(7000)
              ...
              .url().then(function(urlOfPage){
                  ...
                  return browser
                   .url().then(function(urlOfPage1){
                       if(urlOfPage1.indexOf("https://s-4ltrpressonline.cengage.com/products")>-1){
                           console.log(report.reportHeader()
                           + report.stepStatusWithData("Page navigate to product page the url is "+urlOfPage1+" is compared with ", "https://s-4ltrpressonline.cengage.com/products", "success")
                           + report.reportFooter());
                           done();
                        }else{
                           console.log(report.reportHeader()
                           + report.stepStatusWithData("Page navigate to product page the url is "+urlOfPage1+" is compared with ", "https://s-4ltrpressonline.cengage.com/products", "failure")
                           + report.reportFooter());
                        }
                   });
               }
