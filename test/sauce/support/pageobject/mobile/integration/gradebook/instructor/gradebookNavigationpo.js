...
module.exports = {
    ...
    navigateToStudentDetailedPageOnGradebook: function (browser, username) {
      return browser
        ...
        //for stage      .waitForElementByXPath("//div[contains(text(),'"+username+"')]", asserters.isDisplayed, 60000)
              .waitForElementByXPath("//div[@class='student-name']//a[contains(text(),'"+username+"')]")
              .click()
    ...
    clickOnCreatedAssessment : function(browser, assessmentname){
       return browser
            .sleep(3000)
            .execute("return (document.evaluate(\"//div[@class='assignment-title']/a[contains(text(),'"+ assessmentname +"')]\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue).click()")
    ...
    navigateToDetailsOfStudentsAttempts : function(browser, assessmentname){
      return browser
          .execute("return (document.evaluate(\"//a[contains(text(),'"+assessmentname+"')]\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue).scrollIntoView()")
          .sleep(2000)
