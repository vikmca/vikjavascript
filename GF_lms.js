...
var gruntConfig = {
    ...
    simplemocha: {
        ltr: {
            ...
            src: [
                // 'test/sauce/sanity/validateTranscriptAndDownloadButtonForEachVideo.js',
             'test/sauce/sanity/gatewayIntegration/validateEndToEndGatewayCourseLaunch.js',
                'test/sauce/sanity/gatewayIntegration/validateDeepLinkAndGradeSync.js'
            ]
