...
;
    ...
    editDueDate: function(browser, assignmentName){
      return browser
           .waitForElementByXPath("//table//tr//td//a[contains(text(),'" +assignmentName+ "')]/../parent::td//following-sibling::td[@class='submitted-col']//div[@class='right-of-pipe due-col']//div[@class='datefield ng-binding simple']", asserters.isDisplayed, 60000).then(function(dueDate){
