...
describe(scriptName + 'STUDENT :: STUDYBIT AND FLASHCARD CREATION OF MATH EQUATION AND STUDYBOARD VALIDATION', function() {
	var browser;
	var allPassed = true;
	var userType;
	var courseName;
	...
	if (stringutil.removeBoundaryQuotes(process.env.RUN_FOR_PRODUCT.toString()) != "MKTG9") {
		...
		before(function(done) {
			...
			totalTime = 0;
			//Reports
			console.log(report.formatTestName("STUDENT :: 4LTR FEATURES :: MATH EQUATION STUDYBIT AND FLASHCARD VALIDATION"));
			console.log("======================================");
