  ...
  describe(scriptName + 'STUDENT :: PUBLISHER FLASHCARDS VALIDATION AND REVIEW', function() {
  	var browser;
  	var allPassed = true;
  	var userType;
  	var courseName;
  	...
  	before(function(done) {
  		...
  		totalTime = 0;
  		//Reports
  		console.log(report.formatTestName("STUDENT :: PUBLISHER FLASHCARD VALIDATION AND REVIEW"));
