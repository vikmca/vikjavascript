...
module.exports = {
	...
	editedAttemptsFromStudentDetaledVieAndLimitTo3: function(browser, assignmentName) {
		return browser
			.sleep(7000)
			.waitForElementByXPath("//td//a[contains(text(),'" + assignmentName + "')]/../parent::td//following-sibling::td[@class='attempts-col']/div[@class='attempts-inner']/div[@class='right-of-pipe attempts']/div[@class='select-style-sm']/select", asserters.isDisplayed, 60000)
			.click()
			.waitForElementByXPath("//td//a[contains(text(),'" + assignmentName + "')]/../parent::td//following-sibling::td[@class='attempts-col']/div[@class='attempts-inner']/div[@class='right-of-pipe attempts']/div[@class='select-style-sm']/select/option[@value='3']", asserters.isDisplayed, 60000)
			.click()
			.sleep(1000);
	},
	...
	editDueDateBeforeTakeAnyAttempt: function(browser, assignmentName) {
		return browser
			...
			.click()
			.sleep(3000)
			.waitForElementByXPath("//table//tr//td//span[contains(text(),'" + assignmentName + "')]/../parent::td//following-sibling::td[@class='submitted-col']//div[@class='right-of-pipe due-col']//div[@class='next']", asserters.isDisplayed, 60000)
			.click()
			.sleep(3000)
			.waitForElementByXPath("((//table//tr//td//span[contains(text(),'" + assignmentName + "')]/../parent::td//following-sibling::td[@class='submitted-col']//div[@class='right-of-pipe due-col']//div[@class='week ng-scope'])[1]//div//span[contains(text(),'1')])[last()]", asserters.isDisplayed, 60000)
			.click();
	},
	...
	selectParticularAssignment: function(browser, assignmentName) {

		return browser
			.elementByXPath("//a[@class='assessment-detail-link ng-binding ng-scope'][text()='" + assignmentName + "']").click();
	},
	...
	getScoredPointsBeforeAttempt: function(browser, assignmentName) {
		return browser
			.waitForElementByXPath("(//td//span[contains(text(),'" + assignmentName + "')]/../parent::td//following-sibling::td[@class='points-col']//div[@class='left-of-pipe'])[1]/span", asserters.isDisplayed, 60000)
			.text();
	},
