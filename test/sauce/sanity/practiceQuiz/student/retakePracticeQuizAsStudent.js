...
describe(scriptName + '4LTR (' + 'STUDENT' + ') :: RETAKE PRACTICE QUIZ EXISTING COURSE', function() {
	var browser;
	var allPassed = true;
	var userType;
	...
	before(function(done) {
		...
		console.log(report.formatTestScriptFileName("***retakePracticeQuizAsStudent.js***"));
	});
