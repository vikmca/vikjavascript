...
module.exports = {
    ...
    setLoginData: function (userType) {
        ...
        if (userType === "instructor") {
            ...
            if (process.env.RUN_ENV.toString() === "\"integration\"") {
                ...
                data.userId = intTestData.users.instructor[2].credentials.username;
                data.password = intTestData.users.instructor[2].credentials.password;
                ...
                data.userId = prodTestData.users.instructor[3].credentials.username;
                data.password = prodTestData.users.instructor[3].credentials.password;
            ...
            return browser
                ...
                return browser
                  ...
                  //   .maximize()
                    ...
                    .hasElementByCss("#loginFormId input#email").then(function(oldSSO){
                        if(oldSSO){
                            return browser
                            .waitForElementByCss("#loginFormId input#email", asserters.isDisplayed, 60000)
                            .type(data.userId)
                            .sleep(1000)
                            .waitForElementByCss("#loginFormId input#fmPassword", asserters.isDisplayed, 60000)
                            .type(data.password)
                            .sleep(1000)
                            // .execute("window.scrollBy(0,140)")
                            .waitForElementByCss("#loginFormId a.greenWhiteButton", asserters.isDisplayed, 60000)
                            // .waitForElementByXPath("//button[@value='Sign In']", asserters.isDisplayed, 60000)
                            .click()
                            .sleep(7000)
                            .hasElementByXPath("//*[@aria-labelledby='ui-dialog-title-tempConfirmationBox' and contains(@style,'block')]").then(function(displaystatus){
                                         if(displaystatus){
                            ...
                            .hasElementByCss("#h1_large").then(function(errorDisplaystatus){
                                         if(errorDisplaystatus){
                                            console.log(report.reportHeader()
                                            + report.stepStatusWithData("Error appears on login page", errorDisplaystatus, "failure")
                                            + report.reportFooter());
                                             return browser
                                              .refresh()
                                              .sleep(6000)
                        ...
                        .hasElementByCss("#h1_large").then(function(errorDisplaystatus){
                            ...
                            console.log("stringutil.removeBoundaryQuotes(process.env.RUN_FOR_REGION.toString())"+stringutil.removeBoundaryQuotes(process.env.RUN_FOR_REGION.toString()));
              ...
              if(stringutil.removeBoundaryQuotes(process.env.RUN_FOR_REGION.toString()) == "ASI"){
               return browser
                   ...
                   .hasElementByXPath("//ul//span[contains(text(),'" + courseName + "')]");
                     ...
                     return browser
                         .sleep(1000)
                         .waitForElementByXPath("//a[contains(text(),'My Dashboard')]", asserters.isDisplayed, 90000)
                         .click()
                         .sleep(3000)
    ...
    launchACourseOfMyCengageNow: function (userType, courseName, editedCourseName, browser, done) {
       ...
       launchCoursesOnManageCourse: function(browser, courseIndex, done){
          browser
              .waitForElementByXPath("(//td[@id='courseNameColumn']//a)["+courseIndex+"]", asserters.isDisplayed, 30000)
              .execute("return document.evaluate(\"(//td[@id='courseNameColumn']//a)["+courseIndex+"]\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click()")
              .sleep(2000)
              .windowHandles().then(function (handles) {
                var cengageBrain = handles[1];
                  return  browser
        ...
        getCourseName: function(browser, courseIndex){
              return browser
                  .waitForElementByXPath("(//td[@id='courseNameColumn']//a)["+courseIndex+"]", asserters.isDisplayed, 30000).text();
          },
               ...
               .url().then(function(urlOfPage){
                   ...
                   return browser
                    .url().then(function(urlOfPage1){
                        if(urlOfPage1.indexOf("https://4ltr-dev.cengage.info/products")>-1){
                            console.log(report.reportHeader()
                            + report.stepStatusWithData("Page navigate to product page the url is "+urlOfPage1+" is compared with ", "https://4ltr-dev.cengage.info/products", "success")
                            + report.reportFooter());
                            done();
                         }else{
                            console.log(report.reportHeader()
                            + report.stepStatusWithData("Page navigate to product page the url is "+urlOfPage1+" is compared with ", "https://4ltr-dev.cengage.info/products", "failure")
                            + report.reportFooter());
                         }
                    });
                }
