...
var gruntConfig = {
	...
	simplemocha: {
		ltr: {
			...
			src: [
				'test/sauce/sanity/cas/createPracticeQuizMultipleTimes.js'
			]
		}
	},
	jshint: {
...
module.exports = function(grunt) {
	...
	var practiceQuizCount = grunt.option('practiceQuizCount') || config.practiceQuizCounts;
...
//for iOS
	...
	gruntConfig.env.common = {
		...
		PRACTICE_QUIZ_ATTEMPT_COUNT: JSON.stringify(practiceQuizCount),
		RUN_IN_KEYWORDFORID: JSON.stringify(keyWordForId),
