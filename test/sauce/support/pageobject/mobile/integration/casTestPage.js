...
module.exports = {
    ...
    fetchTheCountOfIncorrectAnswerFromList: function (browser) {
        return browser
            .sleep(5000)
            .waitForElementsByCss(".review-item.clearfix", asserters.isDisplayed, 30000);
    },
        ...
        return browser
            ...
            .then(function (casSubmit) {
              ...
              return  browser
                    ...
                    .execute("return document.getElementsByClassName('cas-activity-actionBar')[0].scrollIntoView()")
                    .sleep(2000)
    ...
    clickOnPastQuizButton: function (browser){
      ...
      console.log("pastQuizButtonOnResultPage"+pastQuizButtonOnResultPage);
      return browser
