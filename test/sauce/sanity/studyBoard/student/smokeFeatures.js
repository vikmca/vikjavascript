...
describe(scriptName + 'STUDENT :: STUDYBIT, FLASHCARD, NOTES CREATION AND CONCEPT TRACKER VALIDATION', function() {
	var browser;
	var allPassed = true;
	var userType;
	var courseName;
	...
	before(function(done) {
		...
		totalTime = 0;
		//Reports
		console.log(report.formatTestName("STUDENT :: 4LTR SMOKE FEATURES :: STUDYBIT, FLASHCARD, NOTES CREATION AND CONCEPT TRACKER VALIDATION"));
		console.log("======================================");
