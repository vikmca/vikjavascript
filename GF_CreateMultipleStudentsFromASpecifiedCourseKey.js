...
var gruntConfig = {
    ...
    simplemocha: {
        ltr: {
          ...
          reporterOptions: {
             reportName: 'GF_CreateMultipleStudentsFromASpecifiedCourseKey_result'
           },
          timeout: 60000,
          colors: true,
          summery: true,
          captureFile: 'GF_CreateMultipleStudentsFromASpecifiedCourseKey_result.html', // Optionally capture the reporter output to a file
          ...
          clearRequireCache: true
            ...
            src: [
              'test/sauce/sanity/studentCreation/createMultipleStudentsAndRegisterWithSpecificCourseKey.js',
            ]
