...
describe(scriptName + 'STUDENT :: Flashcards on the title TOC page', function() {
	...
	before(function(done) {
		...
		totalTime = 0;
		//Reports
		console.log(report.formatTestName("STUDENT :: FLASHCARD REVIEW DECK::  VALIDATE FLASHCARD CHANGED ON REVIEW DECK PERSIST ON FLASHCARD AND CHAPTER TILES BOTH VIEW "));
