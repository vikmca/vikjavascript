    ...
    validateAvgScoreOnStudentGradebook: function (browser, assignmentName, classAverage, done) {
        return browser
                ...
                //     assignmentRows[0].elementByCss("td.avg-col div.left-of-pipe span").text().then(function (valueofclassavg) {
                        .waitForElementsByXPath("//span[contains(text(),'"+assignmentName+"')]/parent::td/following-sibling::td[@class='avg-col']//div[@class='left-of-pipe']", asserters.isDisplayed, 60000).text().then(function (valueofclassavg) {
