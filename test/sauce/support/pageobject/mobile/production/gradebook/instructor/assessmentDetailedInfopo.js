...
module.exports = {
    ...
    clickOnMaxPercentageValue: function(browser, percentageValue){
      return browser
          .waitForElementByXPath("(//option[contains(@label,'"+percentageValue+"')])[1]", asserters.isDisplayed, 60000)
          .click()
    },
    getCorrectQuestionCount: function(browser, percentageValue){
       return browser
           .waitForElementByCss("#correct", asserters.isDisplayed, 60000)
           .text();
     }
