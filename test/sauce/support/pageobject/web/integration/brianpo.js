...
module.exports = {
    ...
    selectProduct: function (product, browser, done) {
        if (product === "MKTG9") {
             browser.sleep(3000).hasElementByXPath("//option[contains(@value,'"+testData.products.isbn.MKTG9+"') and contains(@selected,'selected')]").then(function(status){
                 if(!status){
                    browser
            ...
            browser.sleep(3000).hasElementByXPath("//option[contains(@value,'"+testData.products.isbn.PSYCH4+"') and contains(@selected,'selected')]").then(function(status){
                if(!status){
                   browser
            ...
            browser.sleep(3000).hasElementByXPath("//option[contains(@value,'"+testData.products.isbn.ORGB5+"') and contains(@selected,'selected')]").then(function(status){
                if(!status){
                   browser
             ...
             browser.sleep(3000).hasElementByXPath("//option[contains(@value,'"+testData.products.isbn.COMM4+"') and contains(@selected,'selected')]").then(function(status){
                 if(!status){
                    browser
              ...
              browser.sleep(3000).hasElementByXPath("//option[contains(@value,'"+testData.products.isbn.PFIN6+"') and contains(@selected,'selected')]").then(function(status){
                  if(!status){
                     browser
             ...
             browser.sleep(3000).hasElementByXPath("//option[contains(@value,'"+testData.products.isbn.MIS7+"') and contains(@selected,'selected')]").then(function(status){
                 if(!status){
                    browser
         ...
         }else if(product === "SOC5"){
             browser.sleep(3000).hasElementByXPath("//option[contains(@value,'"+testData.products.isbn.SOC5+"') and contains(@selected,'selected')]").then(function(status){
                 if(!status){
                    browser
                        .elementByCssSelectorWhenReady("#productISBN option[value='" + testData.products.isbn.SOC5 + "']", 20000)
                        .click()
                        .nodeify(done);
                   }else{
                        done();
