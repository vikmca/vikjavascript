...
module.exports = {
    ...
    createFlashcard: function (browser) {
        return browser
            ...
            .sleep(3000)
            .hideKeyboard()
            .execute("return (document.evaluate(\"(//textarea[@name='back'])[1]\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue).scrollIntoView()")
            .sleep(1000)
            ...
            .click()
            .sleep(1000)
            .execute("return (document.evaluate(\"//cg-flashcard-form//div[@class='actions']//button[contains(.,'Done')]\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue).scrollIntoView()")
            .sleep(1000)
            .execute("return window.scrollBy(0,-140)")
            .sleep(1000)
            .elementByXPathSelectorWhenReady("//cg-flashcard-form//div[@class='actions']//button[contains(.,'Done')]", 10000)
    ...
    closeExpandedFlashcard : function(browser,done){
      ...
      .waitForElementByXPath("//button[contains(@class,'icon-close-x-blue')]", asserters.isDisplayed, 60000).then(function(scrollToCloseIcon){
        ...
        // .click()
        .execute("return document.getElementsByClassName('icon-close-x-blue')[0].click()")
        .nodeify(done);
      });
    },
  ...
  expandTheFlashCard : function(browser){
    return browser
        ...
        .waitForElementByCss(".studybits div[data-ordinal='1'] ul li:nth-child(4)", asserters.isDisplayed, 90000)
  ...
  fetchTextOnKeytermFlashcard: function (browser) {
    ...
    //  .waitForElementByXPath("(//section[contains(@class,'studybits')]//div[@class='front'])[1]",asserters.isDisplayed, 90000)
     .execute("return document.getElementsByClassName('studybits')[0].getElementsByClassName('content')[1].getElementsByTagName('p')[0].textContent;");
  },
editChapterOfKeyTermFlashcard: function (browser, chapter) {
  return browser
  // .waitForElementByXPath("//select", asserters.isDisplayed, 90000)
